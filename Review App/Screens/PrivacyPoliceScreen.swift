//
//  PrivacyPoliceScreen.swift
//  Review App
//
//  Created by Bilal Ahmed on 07/03/2023.
//

import SwiftUI

struct PrivacyPoliceScreen: View {
    ...
    var body: some View {
        ...
        ScrollView(.vertical, showsIndicators: false){
            ...
            VStack(alignment: .leading, spacing: 10) {
                Group{
                    Text("The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.").font(.headline)
                    Text("Definitions").font(.title)
                    Text("For the purposes of this Privacy Policy:").font(.subheadline)
                    ...
                    Text("Application refers to CodeCue Solutions SMC PVT LTD, the software program provided by the Company.")
                    Text("Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to CodeCue Solutions SMC PVT LTD")
                    Text("Country refers to: Pakistan")
                ...
                Group{
                    ...
                    Text("You mean the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.")
                    Text("Collecting and Using Your Personal Data").font(.title)
                    Text("Types of Data Collected").font(.subheadline)
                    Text("Personal Data")
                ...
                Group{
                    ...
                    Text("Information Collected while Using the Application").font(.subheadline)
                    Text("While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:")
                }
                Group{
                    Text("Address, State, Province, ZIP/Postal code, City")
                ...
                Text("We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.\n\nWe will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the \"Last updated\" date at the top of this Privacy Policy.\n\nYou are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.\n\nContact Us\n\nIf you have any questions about this Privacy Policy, You can contact us on hello@codecue.solutions")
